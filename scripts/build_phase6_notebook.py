"""Generate ``notebooks/phase6_soil_training.ipynb`` (Phase 6 §C).

One-shot script — runs once locally and writes the notebook. The notebook
itself is uploaded to Google Colab and executed on a T4 / L4 / A100
runtime. Cells 1-4 are setup (no GPU needed); cells 5-12 do the multi-
task training + held-out test-set evaluation.

Exactly 12 cells per PHASE6_PROMPT2_COLAB_NOTEBOOK.md Section C.
"""
...
NOTEBOOK_PATH = PROJECT_ROOT / "notebooks" / "phase6_soil_training.ipynb"
...
# --------------------------------------------------------------------- #
# Cell 5 — Markdown: training configuration
# --------------------------------------------------------------------- #
md(
...
# --------------------------------------------------------------------- #
# Cell 9 — Optimizer / scheduler / scaler / checkpoint manager + resume
# --------------------------------------------------------------------- #
code(
...
# --------------------------------------------------------------------- #
# Cell 11 — Markdown: test-set evaluation
# --------------------------------------------------------------------- #
md(
    "## Test-set evaluation\n"
    "\n"
